...
; 2) Clear out a register where the sum will be stored (Set it to 0 using pxor)
...
_start:
        ...
        pxor    xmm2, xmm2          ; Clear out register to save result
        movsd   xmm0, [floatNum1]   ; movesd is used when working with floats
