;--------------------------------------------------------------------------------
; Steps to subtract floats
; 1) Save floats into registers (whether user input or hard coded floats)
; 2) Use subtract operator
;       -   subsd float2 from float1
...
_start:
        ...
        ; use add operators
        subsd   xmm2, xmm1      ; xmm2 = xmm2 - xmm1
...
;--------------------------
; Output example --
;   Enter a number: 10.32
;   Enter a number: 5.954
;   10.32 - 5.954 = 4.366000
;--------------------------